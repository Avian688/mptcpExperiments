...
PROTOCOLS = {
    ...
    "mporb_olia": {
        ...
        "description": "MPORB Alpha with OLIA opportunistic shifting",
    },
    "mporb_semicoupled_beta": {
        "config": "MpOrbSemiCoupledBeta",
        "tcp_type": "MpOrb",
        "algorithm_class": "MpOrbSemiCoupledBeta",
        "description": "MPORB Beta fair-rate-share coupling",
    },
    ...
    "mporb_semicoupled_zeta": {
        "config": "MpOrbSemiCoupledZeta",
        "tcp_type": "MpOrb",
        "algorithm_class": "MpOrbSemiCoupledZeta",
        "description": "MPORB Zeta whole-path cost coupling",
    },
    "lia": {
        "config": "LiaCoupled",
        "tcp_type": "MpTcp",
